...
public class Converters {
    ...
    @TypeConverter
    public static ComponentName fromString(String str) {
        if (str == null) {
            return null;
        } else {
            String[] vars = str.split(",");
            return new ComponentName(vars[0], vars[1]);
        }
    }

    @TypeConverter
    public static String componentNameToString(ComponentName componentName) {
       return componentName == null ? null : componentName.getPackageName() + "," + componentName.getClassName();
    }
